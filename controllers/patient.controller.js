...
const { generateHash, isValidEmail, generateToken } = require('../utils');
...
const patientControllers = {
    registerPatient : async(req, res) =>{
        ...
        if(!p_fname || !p_lname || !email || !pwd || !genotype || !blood_group || !frequent_ailment ){
        ...
        if(usersFound.rows.length !== 0){
            ...
            const text = `INSERT INTO 
                    patients ("patient_fname", "patient_lname", "email", "pwd", "genotype", "blood_group", "frequent_ailment", created_date, modified_date) VALUES($1, $2, $3, $4, $5, $6, $7, $8, $9) returning *`;
